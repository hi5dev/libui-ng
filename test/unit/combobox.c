...
#define comboboxUnitTest(f)       cmocka_unit_test_setup_teardown ((f), unitTestSetup, unitTestTeardown)

static void
comboboxNew (void **state)
{
...
static void
comboboxNumItemsDefault (void **state)
{
  uiCombobox **c = uiComboboxPtrFromState (state);
...
static void
comboboxSelectedDefault (void **state)
{
  uiCombobox **c = uiComboboxPtrFromState (state);
...
static void
comboboxAppendDuplicate (void **state)
{
  uiCombobox **c         = uiComboboxPtrFromState (state);
...
static void
comboboxSetSelected (void **state)
{
  uiCombobox **c = uiComboboxPtrFromState (state);
...
static void
comboboxInsertAtDuplicate (void **state)
{
  uiCombobox **c         = uiComboboxPtrFromState (state);
  const char  *duplicate = "Duplicate";
...
static void
comboboxClearAppend (void **state)
{
  uiCombobox **c = uiComboboxPtrFromState (state);
...
static void
onChangedNoCall (uiCombobox *, void *)
{
  function_called ();
}

static void
comboboxSetSelectedNoCallback (void **state)
{
  uiCombobox **c = uiComboboxPtrFromState (state);
...
static void
comboboxInsertAtNoCallback (void **state)
{
  uiCombobox **c = uiComboboxPtrFromState (state);
...
static void
comboboxClearEmptyNoCallback (void **state)
{
  uiCombobox **c = uiComboboxPtrFromState (state);
...
static void
comboboxClearNoCallback (void **state)
{
  uiCombobox **c = uiComboboxPtrFromState (state);
...
static void
comboboxDeleteNoCallback (void **state)
{
  uiCombobox **c = uiComboboxPtrFromState (state);
