...
static void
enableItemTest (uiMenuItem *item, uiWindow *, void *data)
{
...
static void
forceOn (uiMenuItem *, uiWindow *, void *)
{
  uiMenuItemSetChecked (enabledItem, 1);
}

static void
forceOff (uiMenuItem *, uiWindow *, void *)
{
  uiMenuItemSetChecked (enabledItem, 0);
}

static void
whatWindow (uiMenuItem *, uiWindow *w, void *)
{
  (void)printf ("menu item clicked on window %p\n", (void *)w);
}

static void
toggleResize (uiMenuItem *item, uiWindow *w, void *data)
{
