...
static void
checkboxOnToggledCb (uiCheckbox *, void *data)
{
  char       str[32];
  uiLabel   *label = data;
  static int count = 0;
...
const char *
checkboxOnToggledGuide ()
{
  return "1.\tYou should see an unchecked checkbox with the text `Checkbox`.\n"
...
checkboxOnToggled ()
{
  ...
  uiCheckbox *checkbox = uiNewCheckbox ("Checkbox");
  uiBoxAppend (hbox, uiControl (checkbox), 0);

  uiLabel *label = uiNewLabel ("Toggle count:");
