...
const char *
separatorVerticalGuide ()
{
  return "1.\tYou should see two labels `1` and `2` placed next to each other\n"
...
const char *
separatorHorizontalGuide ()
{
  return "1.\tYou should see two labels `1` and `2` placed on top of each other.\n"
