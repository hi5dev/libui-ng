...
static void
entryOnChangedCb (uiEntry *, void *data)
{
  char       str[32];
  uiLabel   *label = data;
  static int count = 0;
...
entryOnChangedGuide ()
{
  return "1.\tYou should see an empty text entry box. Next to it should be a label\n"
...
static void
passwordEntryOnChangedCb (uiEntry *e, void *data)
{
  char       str[32];
  uiLabel   *label = data;
  static int count = 0;
...
const char *
passwordEntryOnChangedGuide ()
{
  return "1.\tYou should see an empty password entry box. Next to it should be a\n"
...
static void
searchEntryOnChangedCb (uiEntry *, void *data)
{
  char       str[32];
  uiLabel   *label = data;
  static int count = 0;
...
const char *
searchEntryOnChangedGuide ()
{
  return "1.\tYou should see an empty search box. Next to it should be a label\n"
         "\tdisplaying `Changed count: 0`.\n"
         "\n"
...
searchEntryOnChanged ()
{
  ...
  uiEntry *entry = uiNewSearchEntry ();
  uiBoxAppend (hbox, uiControl (entry), 0);
...
entryLongTextGuide ()
{
  return "1.\tYou should see a text entry box containing the text\n"
...
const char *
entryOverflowTextGuide ()
{
  return "1.\tYou should see a text entry box containing text that overflows.\n"
