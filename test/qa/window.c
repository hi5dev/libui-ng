...
static uiWindow *
windowNew (uiControl *child, const char *(*guide) (void))
{
  uiWindow *w = uiNewWindow ("Quality Assurance", QA_WINDOW_WIDTH, QA_WINDOW_HEIGHT, 0);
...
static void
fullscreenOnToggledCb (uiCheckbox *c, void *data)
{
  uiWindow *w = data;
...
const char *
windowFullscreenGuide ()
{
  return "1.\tOne checkbox:\n"
...
windowFullscreen ()
{
  uiCheckbox *c = uiNewCheckbox ("Fullscreen");
  uiWindow   *w = windowNew (uiControl (c), windowFullscreenGuide);
...
static void
borderlessOnToggledCb (uiCheckbox *c, void *data)
{
  uiWindow *w = data;
...
const char *
windowBorderlessGuide ()
{
  return "Note: This test may not fully work on some Unix window managers.\n"
         "\n"
         "1.\tOne checkbox:\n"
...
windowBorderless ()
{
  uiCheckbox *c = uiNewCheckbox ("Borderless");
  uiWindow   *w = windowNew (uiControl (c), windowBorderlessGuide);
...
static void
resizeableOnToggledCb (uiCheckbox *c, void *data)
{
  uiWindow *w = data;
...
windowResizeable ()
{
  uiCheckbox *c = uiNewCheckbox ("Resizeable");
  uiWindow   *w = windowNew (uiControl (c), windowResizeableGuide);
...
static void
updateFullscreenBorderless (uiWindow *w)
{
...
static void
fullscreenBorderlessBorderlessOnToggledCb (uiCheckbox *c, void *data)
{
  uiWindow *w = data;
...
static void
fullscreenBorderlessFullscreenOnToggledCb (uiCheckbox *c, void *data)
{
  uiWindow *w = data;
...
const char *
windowFullscreenBorderlessGuide ()
{
  return "Note: This test may not fully work on some Unix window managers.\n"
         "\n"
         "1.\tTwo checkboxes:\n"
...
uiControl *
windowFullscreenBorderless ()
{
  uiBox    *vbox = uiNewVerticalBox ();
  uiWindow *w    = windowNew (uiControl (vbox), windowFullscreenBorderlessGuide);
...
static void
updateFullscreenResizeable (uiWindow *w)
{
  uiCheckboxSetChecked (fullscreen, uiWindowFullscreen (w));
...
static void
fullscreenResizeableFullscreenOnToggledCb (uiCheckbox *c, void *data)
{
  uiWindow *w = data;
...
static void
fullscreenResizeableResizeableOnToggledCb (uiCheckbox *c, void *data)
{
  uiWindow *w = data;
...
const char *
windowFullscreenResizeableGuide ()
{
  return "Note: This test may not fully work on some Unix window managers.\n"
         "\n"
         "1.\tTwo checkboxes:\n"
...
uiControl *
windowFullscreenResizeable ()
{
  uiBox    *vbox = uiNewVerticalBox ();
  uiWindow *w    = windowNew (uiControl (vbox), windowFullscreenResizeableGuide);
...
static void
updateResizeableBorderless (uiWindow *w)
{
  uiCheckboxSetChecked (resizeable, uiWindowResizeable (w));
  uiCheckboxSetChecked (borderless, uiWindowBorderless (w));
}
...
static void
resizeableBorderlessBorderlessOnToggledCb (uiCheckbox *c, void *data)
{
  uiWindow *w = data;
...
static void
resizeableBorderlessResizeableOnToggledCb (uiCheckbox *c, void *data)
{
  uiWindow *w = data;
...
const char *
windowResizeableBorderlessGuide ()
{
  return "Note: This test may not fully work on some Unix window managers.\n"
         "\n"
         "1.\tTwo checkboxes:\n"
...
uiControl *
windowResizeableBorderless ()
{
  uiBox    *vbox = uiNewVerticalBox ();
  uiWindow *w    = windowNew (uiControl (vbox), windowResizeableBorderlessGuide);
